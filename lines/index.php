                  ...
                  <nav class="navbar navbar-expand-lg navbar-light w-100 ">
                     <ul class="navbar-nav w-100 d-flex justify-content-between">
                        ...
                        for($i=0;$i<count($menu);$i++){
                           ...
                           ?>
                           <li class="nav-item ">
                           <a class="nav-link active" href="#"><?=$menu[$i]->TenMenu?></a>
                           </li>
                           <?php
                           }else{
                              ?>
                        ...
                        <!-- <li class="nav-item ">
                           <a class="nav-link" href="#">Thanh toan</a>
                        </li>
                        <li class="nav-item dropdown ">
                           <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Tien ich</a>
                           <div class="dropdown-menu">
                              <a class="dropdown-item" href="#one">one</a>
                              <a class="dropdown-item" href="#two">two</a>
                              <a class="dropdown-item" href="#th">three</a>
                           </div>
                        </li>
                        <li class="nav-item ">
                           <a class="nav-link" href="#">Dai li</a>
                        </li>
                        <li class="nav-item dropdown ">
                        ...
                        <li class="nav-item ">
                           <a class="nav-link" href="#">Y kien khach hang</a>
                        </li> -->
                     </ul>
                  </nav>
               </div>
